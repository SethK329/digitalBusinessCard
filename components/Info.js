...
export default function Info(){
    return(
        <div className = "info">
            ...
            <a className = "text-link" href ="https://github.com/SethK329">Github Profile</a>
            <div className ="button-container">
                <a href ="mailto:sethk329@gmail.com" className = "button">
                ...
                Email</a>
                <a href ="https://www.linkedin.com/in/seth-kuhn-a1a9b3140/" className ="button blue">
